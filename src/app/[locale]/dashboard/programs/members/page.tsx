...
import ProgramMembersClient from '@/components/ProgramMembersClient';

interface PageProps {
  params: Promise<{ locale: string }>;
}

export default async function ProgramMembersPage({ params }: PageProps) {
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-7xl">
      <ProgramMembersClient locale={locale as Locale} dict={dict} />
    </div>
  );
}
